...
export default function LifelongLearningStep({
    ...
    const formatErrorMessage = (message) => {
        ...
        // Format messages like "The workActivities.0.description field is required."
        return message.replace(/The ([a-zA-Z]+)\.(\d+)\.([a-zA-Z]+) field/, 'This field');
    };
                    ...
                    <div key={index} className="border p-4 rounded-lg space-y-4">
                        <div className="relative">
                            <TextArea
                                ...
                                className={`mt-1 block w-full ${errors[`hobbies.${index}.description`] ? 'border-red-500 pr-10 text-red-900 placeholder-red-300 focus:border-red-500 focus:ring-red-500' : ''}`}
                                rows={3}
                        ...
                        {errors[`hobbies.${index}.description`] && (
                            <p className="mt-2 text-sm text-red-600">
                                {formatErrorMessage(errors[`hobbies.${index}.description`])}
                            </p>
                        )}
                    ...
                    <div key={index} className="border p-4 rounded-lg space-y-4">
                        <div className="relative">
                            <TextArea
                                ...
                                className={`mt-1 block w-full ${errors[`specialSkills.${index}.description`] ? 'border-red-500 pr-10 text-red-900 placeholder-red-300 focus:border-red-500 focus:ring-red-500' : ''}`}
                                rows={3}
                        ...
                        {errors[`specialSkills.${index}.description`] && (
                            <p className="mt-2 text-sm text-red-600">
                                {formatErrorMessage(errors[`specialSkills.${index}.description`])}
                            </p>
                        )}
                    ...
                    <div key={index} className="border p-4 rounded-lg space-y-4">
                        <div className="relative">
                            <TextArea
                                ...
                                className={`mt-1 block w-full ${errors[`workActivities.${index}.description`] ? 'border-red-500 pr-10 text-red-900 placeholder-red-300 focus:border-red-500 focus:ring-red-500' : ''}`}
                                rows={4}
                        ...
                        {errors[`workActivities.${index}.description`] && (
                            <p className="mt-2 text-sm text-red-600">
                                {formatErrorMessage(errors[`workActivities.${index}.description`])}
                            </p>
                        )}
                ...
                {formData.volunteerActivities.map((activity, index) => (
                    <div key={index} className="border p-4 rounded-lg space-y-4">
                        <div className="relative">
                            <TextArea
                                value={activity.description}
                                className={`mt-1 block w-full ${errors[`volunteerActivities.${index}.description`] ? 'border-red-500 pr-10 text-red-900 placeholder-red-300 focus:border-red-500 focus:ring-red-500' : ''}`}
                                rows={4}
                        ...
                        {errors[`volunteerActivities.${index}.description`] && (
                            <p className="mt-2 text-sm text-red-600">
                                {formatErrorMessage(errors[`volunteerActivities.${index}.description`])}
                            </p>
                        )}
                    ...
                    <div key={index} className="border p-4 rounded-lg space-y-4">
                        <div className="relative">
                            <TextArea
                                ...
                                className={`mt-1 block w-full ${errors[`travels.${index}.description`] ? 'border-red-500 pr-10 text-red-900 placeholder-red-300 focus:border-red-500 focus:ring-red-500' : ''}`}
                                rows={4}
                        ...
                        {errors[`travels.${index}.description`] && (
                            <p className="mt-2 text-sm text-red-600">
                                {formatErrorMessage(errors[`travels.${index}.description`])}
                            </p>
                        )}
